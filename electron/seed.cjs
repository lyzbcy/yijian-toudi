...
const companies = [
  ...
  { id: 'baidu', name: '百度', short: '百', color: '#2932e1', logoUrl: './assets/logos/baidu.svg', portal: 'https://talent.baidu.com/', tags: ['500强', 'AI公司'], adapterStatus: 'adapter-ready', capabilities: { jobs: 'verified', login: 'manual', resume: 'unsupported', apply: 'manual', status: 'unsupported' }, lastVerifiedAt: VERIFIED, enabled: true },
  { id: 'bytedance', name: '字节跳动', short: '字', color: '#111827', logoUrl: './assets/logos/bytedance.svg', portal: 'https://jobs.bytedance.com/', tags: ['500强', 'AI公司'], adapterStatus: 'adapter-ready', capabilities: { jobs: 'verified', login: 'manual', resume: 'unsupported', apply: 'manual', status: 'unsupported' }, lastVerifiedAt: VERIFIED, enabled: true },
  ...
  { id: 'meituan', name: '美团', short: '美', color: '#ffc300', logoUrl: './assets/logos/meituan.svg', portal: 'https://zhaopin.meituan.com/', tags: ['500强'], adapterStatus: 'adapter-ready', capabilities: { jobs: 'verified', login: 'manual', resume: 'unsupported', apply: 'manual', status: 'unsupported' }, lastVerifiedAt: VERIFIED, enabled: true },
  { id: 'jd', name: '京东', short: '京', color: '#e1251b', logoUrl: './assets/logos/jd.png', portal: 'https://zhaopin.jd.com/', tags: ['500强'], adapterStatus: 'adapter-ready', capabilities: { jobs: 'verified', login: 'manual', resume: 'unsupported', apply: 'manual', status: 'unsupported' }, lastVerifiedAt: VERIFIED, enabled: true },
  { id: 'xiaomi', name: '小米', short: '米', color: '#ff6900', logoUrl: './assets/logos/xiaomi.svg', portal: 'https://xiaomi.jobs.f.mioffice.cn/', tags: ['500强'], adapterStatus: 'adapter-ready', capabilities: { jobs: 'verified', login: 'manual', resume: 'unsupported', apply: 'manual', status: 'unsupported' }, lastVerifiedAt: VERIFIED, enabled: true },
