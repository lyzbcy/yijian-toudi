...
const GLOBAL_FIELD_RULES = [
  ...
  // 补充信息
  ['extras.summary', ['个人简介', '自我介绍', '自我评价', '个人总结', '其它信息', '其它', 'summary']],
...
const REPEATABLE_GROUPS = [
  ...
  },
  {
    ...
    fields: [
      ['company', ['公司名称', '企业名称', '工作单位', '公司或组织名称', '公司或组织', '公司', 'company']],
      ['department', ['部门', '所在部门', 'department']],
      ['role', ['职位名称', '工作职位', '工作职位名称', '职位或职责', '职位', 'role', 'work']],
      ['level', ['职级', '职位级别', '级别']],
      ['start', ['工作开始时间', '入职时间']],
      ['end', ['工作结束时间', '离职时间']],
  ...
  },
  {
    ...
    fields: [
      ...
      ['contribution', ['个人贡献', '个人职责', '项目职责', '核心贡献', '我的贡献']],
